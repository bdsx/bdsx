...
export type GetFromType<T> = T extends Type<any>
        ...
        if (bitmask !== null) {
            ...
            if (constValue) {
                ...
                builder.desc[key] = {
                    ...
                    set(this: StaticPointer, value: any) {
...
export const void_t = new NativeType<void>(mangle.void, "void_t", 0, 1, v => v === undefined, undefined, emptyFunc, emptyFunc, emptyFunc, emptyFunc, emptyFunc);
...
export class GslSpanToArray<T> extends NativeType<T[]> {
    private constructor(public readonly compType: Type<T>) {
        super(
            getSpanSymbol(compType),
            `GslSpanToArray<${compType.name}>`,
            0x10,
            8,
