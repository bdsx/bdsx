...
struct MinecraftFunctionTable
{
	...
	void hookOnPacketAfter(void(*onPacketAfter)(byte*, ServerNetworkHandler*, Connection* conn)) noexcept;
	void hookOnPacketSend(void(*callback)(NetworkHandler*, const NetworkIdentifier&, Packet*, unsigned char)) noexcept;
	void hookOnPacketSendInternal(Connection* (*callback)(NetworkHandler*, const NetworkIdentifier&, Packet*, String*)) noexcept;
