...
const FIELD_FOR_CLASS = new Set<string>(["`vector deleting destructor'", "`scalar deleting destructor'"]);
...
function parseDeco(base: PdbIdentifier | null, info: ParsingInfo, from: number, sourceFrom: number, eof: string): PdbIdentifier {
...
function parseIdentity(
    eof: string,
    info: {
        isTypeInside?: boolean;
        scope?: PdbIdentifier;
        isClassLike?: boolean;
    } = {},
    scope: PdbIdentifier = PdbIdentifier.global,
): PdbIdentifier {
