...
export function IMAGE_ORDINAL64(Ordinal: string): string {
    return bin.bitand(Ordinal, b64_LOW_WORD);
}
export function IMAGE_SNAP_BY_ORDINAL64(Ordinal: string): boolean {
    return bin.bitand(Ordinal, IMAGE_ORDINAL_FLAG64) !== bin64_t.zero;
}
