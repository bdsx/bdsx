...
class Entity {
    ...
    teleport(pos, dimensionId = enums_1.DimensionId.Overworld) {
...
levelevent4(){
if(__tsb.levelevent4.exports!=null) return __tsb.levelevent4.exports;
const exports=__tsb.levelevent4.exports={};
...
const util_1 = require("../util");
const entityevent_1 = __tsb.entityevent4();
...
// events\miscevent.ts
miscevent4(){
if(__tsb.miscevent4.exports!=null) return __tsb.miscevent4.exports;
const exports=__tsb.miscevent4.exports={};
...
_1.events.queryRegenerate.setInstaller(() => {
    ...
    launcher_1.bedrockServer.afterOpen().then(() => minecraft_1.serverInstance.minecraft.getServerNetworkHandler().updateServerAnnouncement());
});
...
playerevent2(){
if(__tsb.playerevent2.exports!=null) return __tsb.playerevent2.exports;
const exports=__tsb.playerevent2.exports={};
exports.PlayerStartSwimmingEvent = exports.PlayerJumpEvent = exports.PlayerUseItemEvent = exports.PlayerCritEvent = exports.PlayerPickupItemEvent = exports.PlayerJoinEvent = exports.PlayerLevelUpEvent = exports.PlayerRespawnEvent = exports.PlayerInventoryChangeEvent = exports.PlayerDropItemEvent = exports.PlayerAttackEvent = exports.PlayerDisconnectEvent = exports.PlayerLoginEvent = exports.PlayerEvent = void 0;
const _1 = __tsb.events();
const common_1 = require("../common");
const hook_1 = require("../hook");
const minecraft_1 = require("../minecraft");
const util_1 = require("../util");
const item_1 = __tsb.item2();
const itementity_1 = __tsb.itementity2();
...
_1.events.packetAfter(minecraft_1.MinecraftPacketIds.Login).on((ptr, ni, packetId) => {
...
blockevent4(){
if(__tsb.blockevent4.exports!=null) return __tsb.blockevent4.exports;
const exports=__tsb.blockevent4.exports={};
...
const entity_1 = __tsb.entity();
const player_1 = __tsb.player();
const playerevent_1 = __tsb.playerevent2();
...
entityevent4(){
if(__tsb.entityevent4.exports!=null) return __tsb.entityevent4.exports;
const exports=__tsb.entityevent4.exports={};
        ...
        Object.defineProperty(target, entityKey, {
            ...
            set(entity) {
                if (entity.getRawEntity() === null)
                    throw Error(`${entity.getName()} does not have the entity`);
...
// itementity.ts
itementity2(){
if(__tsb.itementity2.exports!=null) return __tsb.itementity2.exports;
const exports=__tsb.itementity2.exports={};
...
// item.ts
item2(){
if(__tsb.item2.exports!=null) return __tsb.item2.exports;
const exports=__tsb.item2.exports={};
exports.Item = void 0;
const minecraft_1 = require("../minecraft");
class Item {
...
tslib:require('tslib'),
__resolve(rpath){
return this.path.join(this.__dirname, rpath);
},
__dirname,
};
// index.ts
