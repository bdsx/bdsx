...
export namespace dll {
    ...
    export namespace ntdll {
        ...
        export const wine_get_version: (() => string) | null = wine_get_version_ptr === null ? null : makefunc.js(wine_get_version_ptr, makefunc.Utf8);
    }
    export namespace kernel32 {
        ...
        export const CreateThread = module.getFunction(
            "CreateThread",
            ThreadHandle,
            null,
            VoidPointer,
    ...
    export namespace ucrtbase {
        ...
        export const _beginthreadex = module.getFunction(
            "_beginthreadex",
            ThreadHandle,
            null,
            VoidPointer,
