...
export class CommandRawEnum extends CommandEnum<string|number> {
    ...
    mapValue(value:EnumResult):string|number {
        ...
        case commandParser.Type.Unknown: return value.token.toLowerCase();
        case commandParser.Type.Int: return value.intValue;
        case commandParser.Type.String: return value.stringValue;
        }
    }
