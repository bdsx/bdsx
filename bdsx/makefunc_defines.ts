...
export const makefuncDefines = {
    fn_JsCreateError: -0x78,
    fn_runtimeErrorFire: -0x70,
    fn_getout: -0x68,
    fn_wrapper_np2js_nullable: -0x60,
    fn_wrapper_np2js: -0x58,
    fn_wrapper_js2np: -0x50,
    fn_stack_free_all: -0x48,
    fn_stack_ansi: -0x40,
    fn_stack_utf8: -0x38,
    fn_js2np_utf16: -0x30,
    ...
    fn_np2js_utf8: 0x38,
    fn_np2js_utf16: 0x40,
    fn_np2js_pointer: 0x48,
    fn_np2js_pointer_nullable: 0x50,
