...
bool checkCode(void* code, kr::Buffer originalCode, kr::Text name) noexcept;
bool checkCode(void* code, kr::Buffer originalCode, kr::Text name, kr::View<std::pair<size_t, size_t> > skip) noexcept;
...
public:
	...
	void patchTo(void* junctionPoint, kr::Buffer originalCode, kr::hook::Register tempregister, bool jump, kr::Text name) noexcept;
