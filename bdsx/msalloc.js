...
var msAlloc;
(function (msAlloc) {
    msAlloc.allocate = makefunc_1.makefunc.js(dllraw_1.dllraw.bedrock_server['??$_Allocate@$0BA@U_Default_allocate_traits@std@@$0A@@std@@YAPEAX_K@Z'], core_1.NativePointer, null, nativetype_1.uint64_as_float_t);
