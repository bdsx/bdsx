...
export class OverloadedEntry {
    constructor(public readonly thisType: Type<any> | null, public readonly args: Type<any>[], public readonly func: (...args: any[]) => any) {}
...
export namespace OverloadedFunction {
    export function make(): OverloadedFunction {
        ...
        tfunc.overload = function (
            this: OverloadedFunction,
            ptr: VoidPointer,
            returnType: makefunc.Paramable,
            opts?: { this?: Type<any> } | null,
            ...args: Type<any>[]
        ): OverloadedFunction {
...
export class NativeTemplateClass extends NativeClass {
    ...
    static make(this: { new (): NativeTemplateClass }, ...items: any[]): any {
        class SpecializedTemplateClass extends (this as {
...
export class NativeFunctionType<T extends (...args: any[]) => any> extends NativeType<T> {
    ...
    static make<OPTS extends MakeFuncOptions<any> | null, RETURN extends makefunc.Paramable, PARAMS extends makefunc.Paramable[]>(
        ...
        opts?: OPTS,
        ...params: PARAMS
    ): NativeFunctionType<FunctionFromTypes_js_without_pointer<OPTS, PARAMS, RETURN>> {
...
function unexpectedUsage(): never {
