...
class AddressIdentifier extends Identifier {
    constructor(name: string | null, public chunk: AsmChunk | null, public offset: number) {
        super(name);
    }
...
class UnresolvedConstant {
    constructor(public offset: number, public readonly bytes: number, public readonly address: AddressIdentifier, public readonly pos: SourcePosition | null) {}
}
...
export class X64Assembler {
    ...
    private _target(
        opcode: number,
        r1: Register | FloatRegister,
        r2: Register | FloatRegister | Operator | null,
        r3: Register | null,
        targetRegister: Register | FloatRegister,
        multiplying: AsmMultiplyConstant,
        offset: number,
        oper: MovOper,
    ): this {
        if (r2 !== null) {
    ...
    movabs_r_c(dest: Register, value: Value64, size: OperationSize = OperationSize.qword): this {
    ...
    movabs_r_cp(dest: Register, address: Value64, size: OperationSize = OperationSize.qword): this {
        if (dest !== Register.rax) throw Error(`Invalid operand ${Register[dest]}`);
        return this._movabs_rax_mem(address, 0, size);
    }

    movabs_cp_r(address: Value64, src: Register, size: OperationSize = OperationSize.qword): this {
    ...
    cmovz_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.je, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovnz_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jne, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovo_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jo, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovno_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jno, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovb_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jb, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovae_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jae, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmove_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.je, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovne_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jne, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovbe_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jbe, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmova_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.ja, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovs_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.js, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovns_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jns, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovp_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jp, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovnp_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jnp, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovl_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jl, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovge_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jge, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovle_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jle, src, dest, null, 1, 0, MovOper.Register, size);
    }
    cmovg_r_r(dest: Register, src: Register, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jg, src, dest, null, 1, 0, MovOper.Register, size);
    }

    cmovz_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.je, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovnz_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jne, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovo_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jo, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovno_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jno, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovb_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jb, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovae_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jae, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmove_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.je, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovne_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jne, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovbe_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jbe, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmova_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.ja, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovs_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.js, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovns_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jns, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovp_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jp, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovnp_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jnp, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovl_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jl, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovge_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jge, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovle_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
        return this._cmov_o(JumpOperation.jle, src, dest, null, multiply, offset, MovOper.Read, size);
    }
    cmovg_r_rp(dest: Register, src: Register, multiply: AsmMultiplyConstant, offset: number, size: OperationSize = OperationSize.qword): this {
    ...
    private _movsx(
        ...
        multiply: AsmMultiplyConstant,
        offset: number,
        destsize: OperationSize,
        srcsize: OperationSize,
        oper: MovOper,
    ): this {
...
class ArgName {
    constructor(public readonly name: string, public readonly short: string) {}
...
export namespace asm {
    ...
    export type Parameter =
        | ParameterRegister
        | ParameterRegisterPointer
        | ParameterConstantPointer
        | ParameterRegisterRegisterPointer
        | ParameterFloatRegister
        | ParameterFarPointer
        | ParameterConstant
        | ParameterLabel;
    ...
    export class Operation {
        ...
        constructor(public readonly code: (this: X64Assembler, ...args: any[]) => X64Assembler, public readonly args: any[]) {}
    ...
    export class Operations {
        constructor(public readonly operations: asm.Operation[], public readonly size: number) {}
