...
const symbols = [
    ...
    'ItemStackBase::getDescriptionId',
    ...
    'ItemStackBase::_getHoverFormattingPrefix',
    'ItemStackBase::getBaseRepairCost',
    'ItemStackBase::setRepairCost',
    'ItemStackBase::hasSameUserData',
    'ItemStackBase::hasSameAuxValue',
    'ItemStackBase::setUserData',
    'ItemStackBase::getNetworkUserData',
    'ItemStackBase::addCustomUserData',
    'ItemStackBase::getArmorSlot',
    'ItemStackBase::~ItemStackBase',
    'ItemStackBase::updateComponent',
    'ItemStackBase::toString',
    'ItemStackBase::toDebugString',
    'ItemStackBase::setNull',
    'ItemStackBase::setChargedItem',
    'ItemStackBase::serializeComponents',
    'ItemStackBase::saveEnchantsToUserData',
    'ItemStackBase::save',
    'ItemStackBase::sameItemAndAux',
    'ItemStackBase::operator=',
    'ItemStackBase::operator!=',
    'ItemStackBase::matchesItem',
    'ItemStackBase::matchesEitherWearableCase',
    'ItemStackBase::matches',
    'ItemStackBase::isOneOfInstances',
