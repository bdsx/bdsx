...
export class BlockPos extends NativeStruct {
    ...
    inc(a: number | Vec3 | BlockPos, b: number = 0, c: number = 0): BlockPos {
        if (typeof a === 'number') {
            return BlockPos.create(this.x + Math.round(a), this.y + Math.round(b), this.z + Math.round(c));
        } else {
...
export class ChunkPos extends NativeStruct {
    ...
    static create(a: number | BlockPos, b: number = 0): ChunkPos {
...
export class ChunkBlockPos extends NativeStruct {
    ...
    static create(a: number | BlockPos, b: number = 0, c: number = 0): ChunkBlockPos {
...
export class Vec3 extends NativeStruct {
    ...
    static create(a: number | BlockPos | Vec3, b: number = 0, c: number = 0): Vec3 {
