...
ItemStack.prototype.sameItem = procHacker.js("ItemStackBase::sameItem", bool_t, {this:ItemStack}, int32_t, int32_t);
...
ItemStack.prototype.getDescriptionId = procHacker.js("ItemStackBase::getDescriptionId", CxxString, {this:ItemStack});
ItemStack.prototype._setItem = procHacker.js("ItemStackBase::_setItem", bool_t, {this:ItemStack}, int32_t, bool_t);
ItemStack.prototype.set = procHacker.js("ItemStackBase::set", void_t, {this:ItemStack}, int32_t);
// ItemStack.prototype.ItemStackBase = procHacker.js("ItemStackBase::ItemStack", void_t, {this:ItemStack});
ItemStack.prototype.init = procHacker.js("ItemStackBase::init", void_t, {this:ItemStack}, int32_t, int32_t, int32_t, CompoundTag);
ItemStack.prototype.initItem = procHacker.js("ItemStackBase::init", void_t, {this:ItemStack}, Item, int32_t, int32_t, CompoundTag);
ItemStack.prototype.initLegacy = procHacker.js("ItemStackBase::init", void_t, {this:ItemStack}, BlockLegacy, int32_t);
ItemStack.prototype.resetHoverName = procHacker.js("ItemStackBase::resetHoverName", void_t, {this:ItemStack});
