...
ListTag.prototype[NativeType.dtor] = procHacker.js("??1ListTag@@UEAA@XZ", void_t, {this:ListTag}); // TODO: test destructor as CompoundTag's destructor does not work
...
ListTag.prototype.append = procHacker.js("?add@ListTag@@QEAAXV?$unique_ptr@VTag@@U?$default_delete@VTag@@@std@@@std@@@Z", void_t, {this:ListTag}, Tag);
ListTag.prototype.copy = procHacker.js("?copy@ListTag@@UEBA?AV?$unique_ptr@VTag@@U?$default_delete@VTag@@@std@@@std@@XZ", Tag, {this:ListTag});
ListTag.prototype.copyList = procHacker.js("?copyList@ListTag@@QEBA?AV?$unique_ptr@VListTag@@U?$default_delete@VListTag@@@std@@@std@@XZ", ListTag, {this:ListTag});
ListTag.prototype.deleteChildren = procHacker.js("?deleteChildren@ListTag@@UEAAXXZ", void_t, {this:ListTag});
ListTag.prototype.equals = procHacker.js("?equals@ListTag@@UEBA_NAEBVTag@@@Z", bool_t, {this:ListTag}, Tag);
ListTag.prototype.get = procHacker.js("?get@ListTag@@QEBAPEAVTag@@H@Z", Tag, {this:ListTag}, int32_t);
ListTag.prototype.getCompound = procHacker.js("?getCompound@ListTag@@QEBAPEBVCompoundTag@@_K@Z", CompoundTag, {this:ListTag}, int32_t);
ListTag.prototype.getDouble = procHacker.js("?getDouble@ListTag@@QEBANH@Z", int32_t, {this:ListTag}, int32_t);
ListTag.prototype.getFloat = procHacker.js("?getFloat@ListTag@@QEBAMH@Z", int32_t, {this:ListTag}, int32_t);
ListTag.prototype.getInt = procHacker.js("?getInt@ListTag@@QEBAHH@Z", int32_t, {this:ListTag}, int32_t);
ListTag.prototype.getStringValue = procHacker.js("?getString@ListTag@@QEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@H@Z", CxxString, {this:ListTag}, int32_t);
