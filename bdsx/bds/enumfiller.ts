...
enum MinecraftDimension {
    Overworld = "overworld",
    Nether = "nether",
    End = "the end"
}

enum MinecraftParticleEffect {
    /**
     * Beacon effects
     */
...
enum ReceiveFromMinecraftServer {
    /**
...
(global as any).MinecraftComponent = MinecraftComponent;
(global as any).MinecraftDimension = MinecraftDimension;
(global as any).MinecraftParticleEffect = MinecraftParticleEffect;
(global as any).ReceiveFromMinecraftServer = ReceiveFromMinecraftServer;
(global as any).SendToMinecraftServer = SendToMinecraftServer;
