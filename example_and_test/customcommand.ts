...
// raw text
command.register("aaa", "bdsx command example").overload(
    (param, origin, output) => {
...
// optional
command.register("bbb", "optional param example").overload(
    (param, origin, output) => {
...
// relative float, /ccc ~~~
command.register("ddd", "relative float example").overload(
    (param, origin, output) => {
        output.success(
...
// entity
command.register("eee", "entity example").overload(
    (param, origin, output) => {
...
// boolean
command.register("fff", "boolean example").overload(
    (param, origin, output) => {
...
command.register("ggg", "enum example").overload(
    (param, origin, output) => {
...
// json
command.register("hhh", "json example").overload(
    (param, origin, output) => {
...
command.register("iii", "position example").overload(
    (param, origin, output) => {
        // without offset :
...
// block
command.register("jjj", "block example").overload(
    (param, origin, output) => {
