...
// import { CommandPermissionLevel, Player } from 'bdsx/minecraft';
...
// bdsx.command.register('commandthatneedspermission', 'Say "I\'m a cow"').overload((params, origin, result) => {
...
//     if(res) {
//         bdsx.command.execute(`execute "${origin.getName()}" ~ ~ ~ say I'm a cow`);
//     } else {
//         result.error("You don't have permission 'bdsx.example.imacow' needed to use this command");
//     }
// }, {});
// bdsx.command.register('giveperm', 'Give a player a permission', CommandPermissionLevel.Operator).overload((params, origin, res) => {
